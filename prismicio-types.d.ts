...
export interface BentoBoxSliceDefaultPrimary {
  /**
   * Heading2 field in *BentoBox → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento_box.default.primary.heading2
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
...
export interface ColorChangerSliceDefaultPrimary {
  /**
   * Heading2 field in *ColorChanger → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: color_changer.default.primary.heading2
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  heading2: prismic.RichTextField;
...
export interface PurchaseButtonSliceDefaultPrimary {
  /**
   * Eyebow field in *PurchaseButton → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: purchase_button.default.primary.eyebow
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  eyebow: prismic.KeyTextField;
