...
export function Scene() {
  ...
  const [lightIntensityScaler, setLigthIntensityScaler] = useState(0);
  useGSAP(() => {
    ...
    mm.add("(prefers-reduced-motion: no-preference)", () => {
      ...
      gsap.to(
        { lightIntensityScaler: 0 },
        {
          ...
          ease: "power2.inOut",
          onUpdate: function () {
            setLigthIntensityScaler(this.targets()[0].lightIntensityScaler);
          },
        },
      );
      ...
      tl.to(keyboard.position, {
        ...
        .call(() => {
          ...
          if (keyboardAnimationRef.current) {
            ...
            // switch nào nằm bên trái hơn thì animate trước. x nhở hơn -> nằm bên phải, ngc lại
